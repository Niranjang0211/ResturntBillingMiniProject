...
url = "http://172.16.2.40:5000/upload_file"
#file_path = "C:\\Users\\surya.n\\Downloads\\ImageRepository\\Images\\Reference Images\\baj links.png"

folder = r"C:\Users\Niranjan.M\Downloads\Screenshot 2024-07-08 175756\Set2"
...
for i in file_paths:
    with open(i, 'rb') as file:
        ...
        #print(fileName)
        time.sleep(3)
        detectControl = "http://172.16.2.40:5000/detectcontrols"
        detectControlBody = {
            "imagename": fileName,
            "orgid": "52468647263",
            "tokenid": "546img8",
        ...
        if response.status_code == 200:
            ...
            save_path = r"C:\Users\Niranjan.M\Downloads\Screenshot 2024-07-08 175756\Json2"
        ...
        print("Json completed successfully")